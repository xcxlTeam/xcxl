...
{
    public class ChensDataGridViewNumericUpDownCell: DataGridViewTextBoxCell
    {
        ...
        internal const int DATAGRIDVIEWNUMERICUPDOWNCELL_defaultDecimalPlaces = 1;
        ...
        internal const Decimal DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMaximum = (Decimal)10000.0;
        ...
        private static Type defaultEditType = typeof(ChensDataGridViewNumericUpDownEditingControl);
        ...
        /// <summary>
        /// Constructor for the ChensDataGridViewNumericUpDownCell cell type
        /// </summary>
        public ChensDataGridViewNumericUpDownCell()
        {
        ...
        /// <summary>
        /// Returns the current DataGridView EditingControl as a ChensDataGridViewNumericUpDownEditingControl control
        /// </summary>
        private ChensDataGridViewNumericUpDownEditingControl EditingNumericUpDown
        {
            get
            {
                return this.DataGridView.EditingControl as ChensDataGridViewNumericUpDownEditingControl;
            }
        }
        ...
        public override Type EditType
        {
            get
            {
                return defaultEditType; // the type is ChensDataGridViewNumericUpDownEditingControl
            }
        }
        ...
        /// <summary>
        /// Clones a ChensDataGridViewNumericUpDownCell cell, copies all the custom properties.
        /// </summary>
        public override object Clone()
        {
            ChensDataGridViewNumericUpDownCell dataGridViewCell = base.Clone() as ChensDataGridViewNumericUpDownCell;
        ...
        public override void DetachEditingControl()
        {
            ...
            {
                // Editing controls get recycled. Indeed, when a ChensDataGridViewNumericUpDownCell cell gets edited
                // after another ChensDataGridViewNumericUpDownCell cell, the same editing control gets reused for 
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            ChensDataGridViewNumericUpDownEditingControl numericUpDownEditingControl = this.DataGridView.EditingControl as ChensDataGridViewNumericUpDownEditingControl;
            ...
            try
            {
                ...
                if (!cellEdited)
                {
                    if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                    {
                        ...
                        paintingNumericUpDown.TextAlign = ChensDataGridViewNumericUpDownCell.TranslateAlignment(cellStyle.Alignment);
        ...
        {
            return "ChensDataGridViewNumericUpDownCell { ColumnIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + RowIndex.ToString(CultureInfo.CurrentCulture) + " }";
        }
