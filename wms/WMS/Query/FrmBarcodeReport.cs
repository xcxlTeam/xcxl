...
//状态或货位作条件做筛选并统计数量
    public partial class FrmBarcodeReport : Form
    {
        ...
        private void FrmBarcodeReport_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            string barcode = null, voucherno = null, Socode = null, Covenantcode = null, materialno = null, materialdesc = null, materialstd = null, strErrMsg = null;
            ...
            if(!WMS.Common.WMSWebService.service.QueryBarcodeDetailsReport(barcode,voucherno,null,Socode,Covenantcode,materialno,materialdesc,materialstd,out reportModel,out strErrMsg))
            {
