...
namespace WMS.Query
{
    public partial class FrmStockMoveQuery : Common.FrmBasic
    {
        private DividPage _serverMainPage;
        private TaskTransInfo queryMain;
        private List<TaskTransInfo> lstMain;

        public FrmStockMoveQuery()
        {
            InitializeComponent();
        }

        private void FrmStockMoveQuery_Load(object sender, EventArgs e)
        {
            SetSearchBtn();
            InitForm();
        }

        private void FrmStockMoveQuery_FormClosed(object sender, FormClosedEventArgs e)
        {
