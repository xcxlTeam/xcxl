...
{
    public partial class FrmOutBarcodePrinting : Common.FrmBasic
    {
        public FrmOutBarcodePrinting(List<Barcode_Model> lstBarcode)
        {
            InitializeComponent();
        ...
        private void FrmOutBarcodePrinting_Load(object sender, EventArgs e)
        {
