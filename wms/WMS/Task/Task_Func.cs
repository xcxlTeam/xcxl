...
namespace WMS.Task
{
    public class Task_Func
    {
        ...
        {
            return WMSWebService.service.GetOutSideByDeliveryToSRM(ref DeliveryModel, Common_Var.CurrentUser, ref strErrMsg);
        }
        ...
        {
            return WMSWebService.service.GetTaskMainListByPage(ref modelList, model, ref page, Common_Var.CurrentUser, ref strError);
        }
        ...
        {
            return WMSWebService.service.GetTaskDetailListByPage(ref modelList, model, ref page, Common_Var.CurrentUser, ref strError);
        }
        ...
        //{
        //    return WMSWebService.service.PostOutSideByDeliveryAndPOToSAP(ref DeliveryInfo, Common_Var.CurrentUser, ref strError);
        //}
        ...
        {
            return WMSWebService.service.GetOverViewExportListByPage(ref modelList, model, ref page, Common_Var.CurrentUser, ref strError);
        }
